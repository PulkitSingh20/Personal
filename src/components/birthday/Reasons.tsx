const REASONS = [
  { n: "01", t: "your laugh", d: "the one you try to hide behind your hand — it's my favourite sound." },
  { n: "02", t: "the way you care", d: "softly, quietly, in a hundred small ways nobody notices but me." },
  { n: "03", t: "your 2am thoughts", d: "the unhinged, the brilliant, the ones only i get to hear." },
  { n: "04", t: "your kindness", d: "you make everyone feel a little more seen, a little more loved." },
  { n: "05", t: "your eyes", d: "they say more than your words do — and your words are already a lot." },
  { n: "06", t: "just you", d: "exactly as you are. nothing to add, nothing to change. just you." },
];
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {REASONS.map((r, i) => (
          ...
          >
            ...
            <p className="relative mt-3 text-sm leading-relaxed text-foreground/70">{r.d}</p>
          </article>
        ))}
      </div>
    </section>
